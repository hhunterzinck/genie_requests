...
# Date: 2022-01-06
# Request: 
#     Source: Freedcamp task from Jocelyn: https://freedcamp.com/view/3082480/tasks/44200194
#     Date requested: 2021-01-06
...
# synapse
synid_file_duke_data <- "syn26602640"
synid_file_ucsf_data <- "syn26586228"
synid_file_msk_data <- "syn26612339"
synid_folder_dest <- "syn26023438"

# provenance
prov_name <- "copy file"
prov_desc <- "copy file to Synapse directory for delivery"
prov_exec <- "https://github.com/hhunterzinck/genie_requests/blob/main/2022-01-06_jocelyn_copy_files.R"
