# Description: Get more details on which rows are empty in most recent VICC BPC upload for BLADDER
...
data <- get_synapse_entity_data_in_csv(synid_file_vicc, na.strings = "")
