# Description: Checks for main GENIE DFCI IDs
...
# synapse
synid_file_pat <- "syn21265748"

# parameters 
pids <- c("GENIE-DFCI-269168", "GENIE-DFCI-269209")
...
print(pat %>% filter(is.element(PATIENT_ID, pids)))
