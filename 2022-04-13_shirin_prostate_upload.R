# Description: Check for ineligible patient ID.
...
# synapse
synid_file_msk <- "syn26230493"

# parameters
id_pt <- "GENIE-MSK-P-0027255"
...
data <- get_synapse_entity_data_in_csv(synid_file_msk)

# main ----------------------------

data %>% 
  filter(record_id == id_pt) %>%
